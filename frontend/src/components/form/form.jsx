  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Section 1: بيانات المرسل */}
        <fieldset className={styles.section}>
          <legend className={styles.sectionTitle}>بيانات المرسل</legend>
        ...
        {/* Section 2: بيانات المستقبل */}
        <fieldset className={styles.section}>
          <legend className={styles.sectionTitle}>بيانات المستقبل</legend>
          <div className={styles.grid}>
            <div className={styles.inputGroup}>
        ...
        <fieldset className={styles.section}>
          <legend className={styles.sectionTitle}>تفاصيل الشحنة</legend>
          <div className={styles.grid}>
            <div className={styles.inputGroup}>
